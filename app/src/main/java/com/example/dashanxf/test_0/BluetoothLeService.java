...
public class BluetoothLeService extends Service{
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicWrite(BluetoothGatt gatt,
                                          BluetoothGattCharacteristic characteristic,
                                          int status){
            Log.d("test position","is this before onchanged or after onchanged?");
            if (status == BluetoothGatt.GATT_SUCCESS){
                    //add some delay here for ble characteristic write time
                    for(int i=0;i<10000000;i++){int a=i;}
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt,
                                            BluetoothGattCharacteristic characteristic) {
            broadcastUpdate(ACTION_DATA_AVAILABLE, characteristic);
            Log.d("test position 2","this is onchanged.");
        }
    };
    ...
    public boolean connect(final String address) {
        ...
        Log.d(TAG,"I am able to get here");
	...
	public void writeCharacteristic(BluetoothGattCharacteristic characteristic) {
        ...
        Log.d(TAG, "Writing to ble device");
